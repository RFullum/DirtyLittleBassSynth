...
void OutMeter::resized()
{
    ...
    leftChannelClipBack.setBounds  ( clipLeftArea.getX(), clipLeftArea.getY(), clipLeftArea.getWidth(), clipLeftArea.getHeight() );
    rightChannelClipBack.setBounds ( clipRightArea.getX(), clipRightArea.getY(), clipRightArea.getWidth(), clipRightArea.getHeight() );
    ...
    leftChannelBack.setBounds   ( meterLeftArea.getX(), meterLeftArea.getY(), meterLeftArea.getWidth(), meterLeftArea.getHeight() );
    ...
    rightChannelBack.setBounds  ( meterRightArea.getX(), meterRightArea.getY(), meterRightArea.getWidth(), meterRightArea.getHeight() );
