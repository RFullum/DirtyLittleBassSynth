...
, processor(p)
{
    ...
    auto SliderSetup = [&](juce::Slider                &sliderInstance
                          , juce::Slider::SliderStyle  style
                          , juce::Colour              &sliderFillColor
    ...
    auto ComboBoxSetup = [&](juce::ComboBox &boxInstance, juce::StringArray boxItems)
    {
...
void DirtyLittleBassSynthAudioProcessorEditor::paint(juce::Graphics& g)
{
    ...
    g.fillAll(onyx);
    g.setGradientFill(juce::ColourGradient::vertical(onyx
                                                     , mainOutAreaInner.getHeight() * 0.59f
                                                     , magicMint
                                                     , mainOutAreaInner.getHeight()));
...
void DirtyLittleBassSynthAudioProcessorEditor::timerCallback()
{
    ...
    float outLevel = (processor.outputLevelBuffer.getMagnitude(0, processor.outputLevelBuffer.getNumSamples()) < 0.001f)
                        ? 0.0f
...
{
    // TODO: Check things that should be const or static constexpr
    ...
    headerAreaInner.setBounds(headerReduced.getX()
                              , headerReduced.getY()
                              , headerReduced.getWidth()
                              , headerReduced.getHeight());
    juce::Rectangle<int> titleHeaderArea = juce::Rectangle<int>(headerAreaInner.getX()
                                                                , headerAreaInner.getY()
                                                                , headerAreaInner.getWidth()
                                                                , headerAreaInner.getHeight());
    ...
    mainOutAreaInner.setBounds(mainOutReduced.getX()
                               , mainOutReduced.getY()
                               , mainOutReduced.getWidth()
                               , mainOutReduced.getHeight());
    ...
    oscSectionInner.setBounds(oscSectionReduced.getX()
                              , oscSectionReduced.getY()
                              , oscSectionReduced.getWidth()
                              , oscSectionReduced.getHeight());
    ...
    mainOscSectionInner.setBounds(mainOscSectionReduced.getX()
                                  , mainOscSectionReduced.getY()
                                  , mainOscSectionReduced.getWidth()
                                  , mainOscSectionReduced.getHeight());
    ...
    subOscSectionInner.setBounds(oscSectionReduced2.getX()
                                 , oscSectionReduced2.getY()
                                 , oscSectionReduced2.getWidth()
                                 , oscSectionReduced2.getHeight());
    ...
    oscADSRSectionInner.setBounds(oscADSRSpaceReduced.getX()
                                  , oscADSRSpaceReduced.getY()
                                  , oscADSRSpaceReduced.getWidth()
                                  , oscADSRSpaceReduced.getHeight());
    int rotaryLabelHeight = 60;
    juce::Rectangle<int> rotarySpace = oscADSRSpaceReduced.removeFromBottom(oscADSRSpaceReduced.getHeight() * 0.33f)
                                                          .reduced(sectionSpacerSize * 2.0f);
    
    adsrRotaryInner.setBounds(rotarySpace.getX()
                              , rotarySpace.getY()
                              , rotarySpace.getWidth()
                              , rotarySpace.getHeight());
    ...
    oscADSRSlidersInner.setBounds(oscADSRSpaceReduced.getX()
                                  , oscADSRSpaceReduced.getY()
                                  , oscADSRSpaceReduced.getWidth()
                                  , oscADSRSpaceReduced.getHeight());
    ...
    modSectionInner.setBounds(modSectionReduced.getX()
                              , modSectionReduced.getY()
                              , modSectionReduced.getWidth()
    ...
    ringModSectionInner.setBounds(ringRowArea.getX()
                                  , ringRowArea.getY()
                                  , ringRowArea.getWidth()
                                  , ringRowArea.getHeight());
    frqShftSectionInner.setBounds(frqShftRowArea.getX()
                                  , frqShftRowArea.getY()
                                  , frqShftRowArea.getWidth()
                                  , frqShftRowArea.getHeight());
    sAndHSectionInner.setBounds  (sAndHRowArea.getX()
                                  , sAndHRowArea.getY()
                                  , sAndHRowArea.getWidth()
                                  , sAndHRowArea.getHeight());
    ...
    bottomSectionInner.setBounds(bottomSectionArea.getX()
                                 , bottomSectionArea.getY()
                                 , bottomSectionArea.getWidth()
                                 , bottomSectionArea.getHeight());
    ...
    filterSectionInner.setBounds(filterAreaReduced.getX()
                                 , filterAreaReduced.getY()
                                 , filterAreaReduced.getWidth()
                                 , filterAreaReduced.getHeight());
    ...
    fltADSRSectionInner.setBounds(fltADSRAreaReduced.getX()
                                  , fltADSRAreaReduced.getY()
                                  , fltADSRAreaReduced.getWidth()
                                  , fltADSRAreaReduced.getHeight());
    ...
    lfoSectionInner.setBounds(lfoAreaReduced.getX()
                              , lfoAreaReduced.getY()
                              , lfoAreaReduced.getWidth()
                              , lfoAreaReduced.getHeight());
