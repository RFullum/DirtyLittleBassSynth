...
void TitleHeader::paint (juce::Graphics& g)
{
    ...
    juce::Rectangle<float> headerAreaInner = juce::Rectangle<float>( getLocalBounds().getX(), getLocalBounds().getY(),
                                                         getLocalBounds().getWidth(), getLocalBounds().getHeight() );
    
    g.setGradientFill      ( juce::ColourGradient::horizontal( lightColor, headerAreaInner.getX(),
